...
off as
\begin{equation}
    |A_i^{(l_i)}| \Big|_{l_i \gg m_i} \sim \frac{1}{\sqrt{l_i}}\,.\todo{wrong!}
\end{equation}
...
We close by remarking that for any angular-momentum cutoff $l < L < \infty$, one can find an upper limit for the squared sum of all remaining partial waves through a comparison with the inclusive decay
width.
