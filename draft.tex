...
method to estimate its effects based on both the method of moments, and MC simulations of the detector.\\

As previous, we use a PDF $P$ decomposed into $N$ angular observables $\lbrace S_k\rbrace$,
\begin{equation}
